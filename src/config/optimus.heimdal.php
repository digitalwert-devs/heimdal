...
use DigitalwertDevs\Heimdal\Formatters;
...
return [
    ...
    'response_factory' => \DigitalwertDevs\Heimdal\ResponseFactory::class,

    'reporters' => [
        /*'sentry' => [
            'class'  => \DigitalwertDevs\Heimdal\Reporters\SentryReporter::class,
            'config' => [
                'dsn' => '',
